    ...
    <ProtectedRoute allowedRoles={["admin"]}>
      ...
      <div>
        ...
        >
          <div className={`w-full md:w-[calc(50%-10px)] lg:flex lg:flex-1 `}>
            <input
              list="company_search"
              name="company_search"
              className={`w-full border flex   text-[16px]  p-2  rounded focus:outline-none placeholder-[#85868B] 
        ...
        dark:text-black h-[40px] border border-[#E7E7E9]`}
          ...
          <div className={`w-full md:w-[calc(50%-10px)] lg:flex lg:flex-1 `}>
            <select
              className={`w-full md:min-w-[100px] lg:min-w-[100px] border flex flex-auto md:flex-1 text-[#85868B]   text-[16px]  p-2 bg-[white] rounded focus:outline-none placeholder-[#85868B] 
