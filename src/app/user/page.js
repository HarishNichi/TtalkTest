      ...
      <div>
        ...
        dark:text-black h-[40px] border border-[#E7E7E9]`}
            ...
            <div className="col-span-12 md:col-span-6 xl:col-span-2">
              <select
                id={"isActive"}
                className={`w-full md:min-w-[100px] lg:min-w-[100px] border flex flex-auto md:flex-1  text-[16px]  p-2 bg-[white] rounded-lg focus:outline-none placeholder-[#85868B] 
