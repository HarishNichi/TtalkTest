...
const FileUploadCard = forwardRef(
  (
    ...
    const handleFileSelect = (event) => {
      ...
      if (!files) {
        setError(intl.file_upload_select_file); // Japanese: "Please select a file."
      ...
      if (!file && isAdd) {
        ...
        if (!sectionName) {
          setTouched((prevTouched) => {
            if (
              !Object.prototype.hasOwnProperty.call(prevTouched, "sectionName")
            ) {
              return {
                ...prevTouched,
                sectionName: true,
          ...
          setErrors((prevState) => {
            if (
              !Object.prototype.hasOwnProperty.call(prevState, "sectionName")
            ) {
              return {
                ...prevState,
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center justify-center flex-grow lg:px-[10px] py-[20px]">
            ...
            <div style={fileCardStyle} className="flex items-center">
              ...
              <div
                ...
                onClick={() => {
                  ...
                  setSubSectionDetails((prevState) => {
                    if (
                      Object.prototype.hasOwnProperty.call(prevState, "file")
                    ) {
                      return {
                        ...prevState,
                        file: "",
          ...
          {((isAdd && !selectedFileName) || (!isAdd && !selectedFileName)) && (
            <div
              className="w-full flex:col items-center justify-center py-[20px]"
