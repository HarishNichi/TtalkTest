    ...
    if (type === "prev") {
      return (
        <div
          ...
          style={{ height: "32px",border: '1px solid #d9d9d9',padding:'0 10px' }}
        >
          <div className="flex justify-center items-center w-full">{getPrevIcon()}</div>
    ...
    if (type === "next") {
      return (
        ...
        >
          ...
          <div className="flex justify-center items-center w-full">{nextIcon()}</div>
        </div>
      );
    }
